...
namespace DiIiS_NA.LoginServer.ServicesSystem.Services
{
    public class InitialLoginTask
    {
        ...
        public void run()
        {
            ...
            Init.SetSyncedVars(
                " OnlineService.Season.Num=1" + //赛季编号
                " OnlineService.Season.State=1" + //赛季状态, 1 - 激活，0 - 停用
                " OnlineService.Leaderboard.Era=1" +
                " OnlineService.AnniversaryEvent.Status=1" + //周年纪念活动，第一届老崔斯特瑞姆
                " ChallengeRift.ChallengeNumber=1" + //传送门号
                " OnlineService.FreeToPlay=true" + //购买白金币
                " OnlineService.Store.Status=0" + //存储状态，0 - 启用，1 - 解锁
                " OnlineService.Store.ProductCatalogDigest=C42DC6117A7008EDA2006542D6C07EAD096DAD90" + //中国
                " OnlineService.Store.ProductCatalogVersion=633565800390338000" + //中文目录
    ...
    public class GameUtilitiesService : bgs.protocol.game_utilities.v1.GameUtilitiesService, IServerService
    {
        ...
        private ByteString GetRatingPersonal(BattleClient Client, ByteString data)
        {
            ...
            switch (request.LeaderboardId)
            {
                case 1:
                    break;
                case 2: NeededClass = ToonClass.Barbarian; break; // 野蛮人
                case 3: NeededClass = ToonClass.Crusader; break; // 十字军
                case 4: NeededClass = ToonClass.DemonHunter; break; // 恶魔猎手
                case 5: NeededClass = ToonClass.Monk; break; // 僧人
                case 6: NeededClass = ToonClass.WitchDoctor; break; // 女巫
                case 7: NeededClass = ToonClass.Wizard; break; // 术士
                case 8: NeededClass = ToonClass.Necromancer; break; // 死灵法师
        ...
        private ByteString SearchGuilds(BattleClient Client, ByteString data)
        {
            ...
            Logger.Trace("公会搜索(): {0}", request.ToString());
        ...
        {
            Logger.Trace("公会踢成员(): {0}", request.ToString());
        ...
        {
            Logger.Trace("公会解散(): {0}", request.ToString());
        ...
        {
            Logger.Trace("公会获取新闻(): {0}", request.ToString());
        ...
        {
            Logger.Trace("公会推广会员(): {0}", request.ToString());
        ...
        {
            Logger.Trace("公会降级成员(): {0}", request.ToString());
        ...
        private ByteString CreateCommunity(BattleClient Client, ByteString data)
        {
            ...
            Logger.Trace("创建社区(): {0}", request.ToString());
